...
export class SnoozeTicketResponseDto extends createZodDto(snoozeTicketResponse) {}
...
export class SnoozeTicketController {
  ...
  async handle(@Param() params: SnoozeTicketParamsDto): Promise<SnoozeTicketResponseDto> {
